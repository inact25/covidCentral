                                ...
                                <div className="col-12 col-md-6 col-lg-6">
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            ...
                                            <p>Stay at home if you begin to feel unwell, even with mild symptoms
                                                nose.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6 col-lg-6">
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            ...
                                            <p>Via respiratory droplets produced when infected person coughs or
                                                sneezes.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6 col-lg-6">
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            ...
                                            <p>Avoiding contact with others and visits to medical facilities will
                                                allow.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6 col-lg-6">
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            ...
                                            <p>Call in advance and tell your provider of any recent travel or
                                                contact.</p>
                                        </div>
                                    </div>
                                </div>
